...
lessons_module_01 = [
  ...
  %{
    ...
    steps: [
      ...
      %{text: "Observa una tecla NEGRA (izquierda). NO LA TOQUES AÚN.", note: 0, hint: "Solo mírala", finger: 0, duration: 0},
      %{text: "Observa una tecla NEGRA (centro). ¿Ves dónde está?", note: 0, hint: "Entre las blancas", finger: 0, duration: 0},
      %{text: "Observa una tecla NEGRA (derecha). ¿Notas el patrón?", note: 0, hint: "Las negras siempre se agrupan", finger: 0, duration: 0},
      ...
      %{text: "Señala el primer grupo de 2 negras (a la izquierda)", note: 0, hint: "Úsalas como referencia", finger: 0, duration: 0},
      %{text: "Señala el primer grupo de 3 negras. ¿Ves cómo son más grandes?", note: 0, hint: "Este grupo tiene 3", finger: 0, duration: 0},
      %{text: "Este patrón se REPITE en todo el piano", note: 0, hint: "Es tu brújula para navegarlo", finger: 0, duration: 0},
      %{text: "Toca una blanca ENTRE las 2 negras", note: 36, hint: "En la izquierda primero", finger: 1, duration: 1},
      %{text: "Toca otra blanca ENTRE las 2 negras (más a la derecha)", note: 40, hint: "Mismo patrón, diferente posición", finger: 1, duration: 1},
      %{text: "Toca una blanca EN EL CENTRO del grupo de 3", note: 60, hint: "La del medio exacto", finger: 1, duration: 1},
