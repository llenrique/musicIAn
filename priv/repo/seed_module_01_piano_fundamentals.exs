...
lessons_module_01 = [
  ...
  %{
    ...
    order: 1,
    steps: [
      %{text: "Mira el piano completo. ¿Cuántas teclas ves?", note: 0, hint: "Son muchas, pero están organizadas", finger: 0, duration: 2},
      %{text: "Observa: hay muchas teclas BLANCAS en el piano", note: 0, hint: "Son la mayoría", finger: 0, duration: 2},
      %{text: "Observa: entre las blancas hay teclas NEGRAS", note: 0, hint: "Están levantadas y agrupadas", finger: 0, duration: 2},
      %{text: "Las teclas negras se agrupan en un patrón especial", note: 0, hint: "Hay grupos de 2 y grupos de 3", finger: 0, duration: 2},
      %{text: "Toca UNA tecla blanca en la IZQUIERDA del piano", note: 36, hint: "Escucha bien el sonido", finger: 1, duration: 2},
      %{text: "Espera. Recuerda ese sonido grave.", note: 0, hint: "Es profundo y bajo", finger: 0, duration: 3},
      %{text: "Ahora toca UNA tecla blanca en el CENTRO del piano", note: 60, hint: "Este sonido es más alto", finger: 1, duration: 2},
      %{text: "Compara: ¿es diferente del sonido anterior?", note: 0, hint: "Sí, es más alto", finger: 0, duration: 3},
      %{text: "Ahora toca UNA tecla blanca en la DERECHA del piano", note: 84, hint: "Este es el más agudo", finger: 1, duration: 2},
      %{text: "Compara los tres sonidos: grave, medio, agudo", note: 0, hint: "El sonido SUBE de izquierda a derecha", finger: 0, duration: 3},
      %{text: "Conclusión: IZQUIERDA = sonidos graves (bajos)", note: 0, hint: "Recuerda esto", finger: 0, duration: 2},
      %{text: "Conclusión: DERECHA = sonidos agudos (altos)", note: 0, hint: "Es importante", finger: 0, duration: 2},
      %{text: "Ahora observa las teclas NEGRAS. Mira su patrón.", note: 0, hint: "¿Ves cómo se agrupan?", finger: 0, duration: 2},
      %{text: "Señala con tu dedo el PRIMER grupo de 2 negras", note: 0, hint: "Están juntas, lado a lado", finger: 0, duration: 2},
      %{text: "Después de las 2 negras, ¿qué viene?", note: 0, hint: "Un grupo MAYOR de negras", finger: 0, duration: 2},
      %{text: "Señala el grupo de 3 negras. ¿Lo ves?", note: 0, hint: "Este grupo es más grande", finger: 0, duration: 2},
      %{text: "El patrón es: 2 NEGRAS, luego 3 NEGRAS, luego se repite", note: 0, hint: "2, 3, 2, 3...", finger: 0, duration: 3},
      %{text: "Mueve tu mano a la DERECHA en el piano", note: 0, hint: "Sin soltar el teclado", finger: 0, duration: 2},
      %{text: "¿Ves? El mismo patrón: 2 negras, 3 negras", note: 0, hint: "Se repite perfectamente", finger: 0, duration: 2},
      %{text: "Mueve tu mano a la IZQUIERDA (hacia los graves)", note: 0, hint: "Sigue mirando el patrón", finger: 0, duration: 2},
      %{text: "El patrón es IDÉNTICO en toda la extensión del piano", note: 0, hint: "Siempre 2, 3, 2, 3...", finger: 0, duration: 3}
    ],
