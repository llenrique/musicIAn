...
lessons_module_04 = [
  %{
    ...
    intro:
      "Tempo = velocidad. El metrónomo marca cada beat. 60 BPM = 1 beat por segundo. 120 BPM = 2 beats por segundo. Escucha el metrónomo y toca Do en cada click.",
    metronome: true,
    timing_strictness: 0,
    time_signature: "4/4",
    loop: true,
    ...
    steps: [
      %{
        text: "Escucha el metrónomo — cuenta 1-2-3-4",
        note: 0,
        hint: "Solo escucha",
        finger: 0,
        duration: 1
      ...
      %{
        text: "Escucha otro compás — siente el pulso",
        note: 0,
        hint: "El click es regular",
        finger: 0,
        duration: 1
      },
      %{
        text: "Toca Do en el primer click",
        note: 60,
        hint: "Al ritmo del metrónomo",
        finger: 1,
        duration: 1
      },
      %{
        text: "Toca Do en el segundo click",
        note: 60,
        hint: "Sigue el pulso",
        finger: 1,
        duration: 1
      ...
      %{
        text: "Toca Do en el cuarto click",
        note: 60,
        hint: "Fin del compás",
        finger: 1,
        duration: 1
      ...
      %{
        text: "Toca Do en el primer click del compás 2",
        note: 60,
        hint: "Nuevo compás",
        finger: 1,
        duration: 1
      ...
      %{
        text: "Toca Do en el cuarto click del compás 2",
        note: 60,
        hint: "¡Tempo constante!",
        finger: 1,
        duration: 1
      }
    ],
  ...
  %{
    ...
    intro:
      "Una redonda dura 4 clicks. Toca la nota y SOSTENLA durante 4 clicks antes de soltarla. No aprietes otra tecla hasta que el cuarto click suene.",
    metronome: true,
    timing_strictness: 2,
    time_signature: "4/4",
    loop: true,
    ...
    steps: [
      %{
        text: "Do — redonda (sostén 4 clicks)",
        note: 60,
        hint: "Cuenta 1-2-3-4 en silencio",
        finger: 1,
        duration: 4
      },
      %{
        text: "Re — redonda (sostén 4 clicks)",
        note: 62,
        hint: "No apures el siguiente",
        finger: 2,
        duration: 4
      },
      %{
        text: "Mi — redonda (sostén 4 clicks)",
        note: 64,
        hint: "4 clicks exactos",
        finger: 3,
        duration: 4
      },
      %{
        text: "Fa — redonda (sostén 4 clicks)",
        note: 65,
        hint: "Sin apurarse",
        finger: 4,
        duration: 4
      ...
      %{
        text: "Sol — redonda (sostén 4 clicks)",
        note: 67,
        hint: "Pulso constante",
        finger: 5,
        duration: 4
      },
      %{
        text: "La — redonda (sostén 4 clicks)",
        note: 69,
        hint: "Sigue el metrónomo",
        finger: 4,
        duration: 4
      },
      %{
        text: "Si — redonda (sostén 4 clicks)",
        note: 71,
        hint: "Casi terminamos",
        finger: 3,
        duration: 4
      },
      %{
        text: "Do alta — redonda (sostén 4 clicks)",
        note: 72,
        hint: "¡Escala completa de redondas!",
        finger: 5,
        duration: 4
      }
    ],
  ...
  %{
    ...
    description:
      "Practica blancas (2 tiempos) manteniendo el pulso. Son el doble de rápido que las redondas.",
    intro:
      "Una blanca dura 2 clicks. Toca, sostén 2 clicks, luego toca la siguiente. El metrónomo te guía. Dos blancas caben exactamente en un compás.",
    metronome: true,
    timing_strictness: 2,
    time_signature: "4/4",
    loop: true,
    ...
    steps: [
      %{
        text: "Do — blanca (sostén 2 clicks)",
        note: 60,
        hint: "Cuenta 1-2",
        finger: 1,
        duration: 2
      ...
      %{
        text: "Re — blanca (sostén 2 clicks)",
        note: 62,
        hint: "Segundo tiempo del compás",
        finger: 2,
        duration: 2
      },
      %{
        text: "Mi — blanca (sostén 2 clicks)",
        note: 64,
        hint: "Primer tiempo del nuevo compás",
        finger: 3,
        duration: 2
      },
      %{
        text: "Fa — blanca (sostén 2 clicks)",
        note: 65,
        hint: "Segundo tiempo",
        finger: 4,
        duration: 2
      ...
      %{
        text: "Sol — blanca (sostén 2 clicks)",
        note: 67,
        hint: "Primer tiempo",
        finger: 5,
        duration: 2
      ...
      %{
        text: "La — blanca (sostén 2 clicks)",
        note: 69,
        hint: "Segundo tiempo",
        finger: 4,
        duration: 2
      ...
      %{
        text: "Si — blanca (sostén 2 clicks)",
        note: 71,
        hint: "Primer tiempo",
        finger: 3,
        duration: 2
      ...
      %{
        text: "Do alta — blanca (sostén 2 clicks)",
        note: 72,
        hint: "¡Escala completa de blancas!",
        finger: 5,
        duration: 2
      }
    ],
  ...
  %{
    ...
    intro:
      "Una negra dura 1 click — toca y suelta inmediatamente. Hay 4 negras por compás. No apures, no te retrases. Deja que el metrónomo sea tu guía.",
    metronome: true,
    timing_strictness: 2,
    time_signature: "4/4",
    loop: true,
  ...
  %{
    ...
    description:
      "Combina redondas, blancas y negras. La suma siempre debe ser 4 tiempos por compás.",
    intro:
      "Ahora mezclamos. Ejemplo: blanca(2) + negra(1) + negra(1) = 4. O: negra(1) + negra(1) + blanca(2) = 4. La suma siempre es 4 en 4/4.",
    metronome: true,
    timing_strictness: 2,
    time_signature: "4/4",
    loop: true,
    ...
    steps: [
      ...
      %{
        text: "Mi — negra (2+1+1=4 ✓)",
        note: 64,
        hint: "Cierra el compás",
        finger: 3,
        duration: 1
      },
  ...
  %{
    ...
    intro:
      "Dos patrones clásicos: (A) negra-negra-blanca (corta-corta-larga). (B) blanca-negra-negra (larga-corta-corta). Los practicaremos en secuencia.",
    metronome: true,
    timing_strictness: 2,
    time_signature: "4/4",
    loop: true,
    ...
    steps: [
      ...
      %{
        text: "Mi — blanca (patrón A: cierre 1+1+2=4 ✓)",
        note: 64,
        hint: "Larga — cierra el compás",
        finger: 3,
        duration: 2
      },
      %{
        text: "Fa — negra (patrón A: segundo compás)",
        note: 65,
        hint: "Corta",
        finger: 4,
        duration: 1
      ...
      %{
        text: "Do alta — negra (patrón B: medio)",
        note: 72,
        hint: "Corta",
        finger: 5,
        duration: 1
      ...
      %{
        text: "Si — negra (patrón B: cierre 2+1+1=4 ✓)",
        note: 71,
        hint: "Corta — cierra el compás",
        finger: 4,
        duration: 1
      },
  ...
  %{
    ...
    intro:
      "Es natural acelerar cuando tocas rápido o desacelerar cuando te cansas. El metrónomo es tu árbitro. Cada click = una negra. Sigue el metrónomo exactamente.",
    metronome: true,
    timing_strictness: 3,
    time_signature: "4/4",
    loop: true,
    ...
    steps: [
      %{
        text: "Do — negra (¡no te adelantes!)",
        note: 60,
        hint: "Exactamente en el click",
        finger: 1,
        duration: 1
      },
  ...
  %{
    ...
    intro:
      "Ejercicio final del módulo. Mezclarás los tres valores de nota en una pieza de 4 compases. Mantén tempo constante en todo momento.",
    metronome: true,
    timing_strictness: 2,
    time_signature: "4/4",
    loop: true,
    ...
    steps: [
      %{
        text: "Do — redonda (compás 1)",
        note: 60,
        hint: "4 tiempos completos",
        finger: 1,
        duration: 4
      },
      %{text: "Re — blanca (compás 2)", note: 62, hint: "2 tiempos", finger: 2, duration: 2},
      %{
        text: "Mi — blanca (compás 2 completo: 2+2=4)",
        note: 64,
        hint: "2 tiempos",
        finger: 3,
        duration: 2
      ...
      %{
        text: "Si — negra (compás 3 completo: 1+1+1+1=4)",
        note: 71,
        hint: "1 tiempo",
        finger: 3,
        duration: 1
      ...
      %{
        text: "La — negra (compás 4 completo: 2+1+1=4)",
        note: 69,
        hint: "1 tiempo — ¡pieza completa!",
        finger: 3,
        duration: 1
      }
    ],
