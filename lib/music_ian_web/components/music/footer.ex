defmodule MusicIanWeb.Components.Music.Footer do
  @moduledoc "Componente Phoenix para el footer de la interfaz musical."
  ...
  def status_bar(assigns) do
    ...
    <div class="bg-slate-900 border-t border-slate-800 px-6 py-2 flex justify-between items-center text-xs text-slate-400 shrink-0 h-10">
      <div class="flex items-center gap-6">
        ...
        <div class="flex items-center gap-2">
          <div class={"w-2 h-2 rounded-full " <> if(@midi_connected, do: "bg-emerald-500 shadow-[0_0_5px_#10b981]", else: "bg-red-500")}>
          </div>
    ...
    <!-- Active Device -->
      ...
      <div class="flex items-center gap-6">
        ...
        <a
          href="/metronome"
          class="hidden md:flex items-center gap-2 hover:text-slate-200 transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
    ...
    <!-- Keyboard Shortcut Hint -->
        <div class="hidden md:flex items-center gap-2">
          <span class="bg-slate-800 px-1.5 py-0.5 rounded text-[10px] font-bold text-slate-300 border border-slate-700">
            Do8
          </span>
